...
static const struct freq_tbl ftbl_gpu_cc_gx_gfx3d_clk_src[] = {
	F(145000000, P_CRC_DIV,  1, 0, 0),
	F(245000000, P_CRC_DIV,  1, 0, 0),
	F(345000000, P_CRC_DIV,  1, 0, 0),
	F(445000000, P_CRC_DIV,  1, 0, 0),
	F(545000000, P_CRC_DIV,  1, 0, 0),
...
static void gpu_cc_gfx_sdm845_fixup_sdm845v2(void)
{
	...
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_MIN] = 145000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_LOWER] =
		245000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_LOW] = 345000000;
	...
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_NOMINAL_L1] =
		645000000;
	gpu_cc_gx_gfx3d_clk_src.clkr.hw.init->rate_max[VDD_GX_HIGH] = 745000000;
